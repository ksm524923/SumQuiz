...
public class JavaAnalysisController {
    ...
    public JavaAnalysisResponse analyze(@RequestPart("file") MultipartFile file,
                                        ...
                                        @RequestParam(value = "difficulty", defaultValue = "균형") String difficulty,
                                        @RequestParam(value = "language", defaultValue = "ko") String language) throws Exception {
        ...
        return generationService.generateAll(userId, new String(file.getBytes(), StandardCharsets.UTF_8), difficulty, language);
    }
}
